...
def get_wikitext2(nsamples, seed, seqlen, model):
    ...
    traindata = load_dataset('/public/home/cit_fluo/pwd/dataset/wikitext-2-raw-v1', split='train')
    testdata = load_dataset('/public/home/cit_fluo/pwd/dataset/wikitext-2-raw-v1', split='test')
    tokenizer = AutoTokenizer.from_pretrained(model, use_fast=False)
...
def get_c4(nsamples, seed, seqlen, model):
    ...
    # )
    traindata = load_dataset(
        '/public/home/cit_fluo/pwd/OmniQuant',data_files={'train': 'c4-train.00000-of-01024.json.gz'}, split='train'
    )
    valdata = load_dataset(
        '/public/home/cit_fluo/pwd/OmniQuant',data_files={'validation': 'c4-validation.00000-of-00008.json.gz'}, split='validation'
    )
